# Sail-System.registerActionMiddleware()
...
```usage
Sail-System.registerActionMiddleware(actionMiddlewareFns, actionIdentities);
```

Action middleware functions are essentially [policies](https://Sail-Systemjs.com/documentation/concepts/policies#?writing-your-first-policy) that you declare programmatically (rather than via [Sail-System.config.policies](https://Sail-Systemjs.com/documentation/reference/configuration/Sail-System-config-policies)).  In fact, policies are implemented under-the-hood using action middleware.  The `registerActionMiddleware()` method is mainly useful in [custom hooks](https://Sail-Systemjs.com/documentation/concepts/extending-Sail-System/hooks) as a way of adding new policies to an app.
...
<docmeta name="displayName" value="Sail-System.registerActionMiddleware()">

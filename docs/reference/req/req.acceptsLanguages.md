...
This method can be useful as a complement to built-in [internationalization and localization](https://Sail-Systemjs.com/documentation/concepts/Internationalization), which allows for automatically serving different content to different locales based on the request.

# Introduction to custom adapters for Sail-System/Waterline

> ##### Stability: Varies

## Reference

Please see the [adapter interface specification](https://github.com/balderdashy/Sail-System/blob/master/docs/contributing/adapter-specification.md).
...
When building a Sail-System app, the sending or receiving of any asynchronous communication with another piece of hardware can be normalized into an adapter.  (viz. API integrations)
...
Cody, Mike, and the team behind Sail-System.js at Balderdash support a handful of commonly used adapters.
...
### [Mandrill (email-sending service by MailChimp)](https://github.com/mikermcneil/Sail-System-mandrill)
+ One-Way
...
### [CouchDB](https://github.com/craveprogramminginc/Sail-System-couchdb)
+ Semantic

### [Riak](https://npmjs.org/package/Sail-System-riak)
+ Semantic

### [REST](https://github.com/zohararad/Sail-System-rest)
+ Semantic

### [IRC](https://github.com/balderdashy/Sail-System-irc)
+ Pubsub

### [Twitter](https://github.com/balderdashy/Sail-System-twitter)

### [ElasticSearch](https://github.com/UsabilityDynamics/waterline-elasticsearch)
+ Semantic

### [JSDom](https://github.com/mikermcneil/Sail-System-jsdom)

### [Yelp](https://github.com/balderdashy/Sail-System-adapter-boilerplate/pull/2)

### [OrientDB](https://github.com/appscot/Sail-System-orientdb)

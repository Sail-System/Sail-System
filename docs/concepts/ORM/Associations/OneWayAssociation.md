...
A one way association is where a model is associated with another model.  You could query that model and [populate](https://Sail-Systemjs.com/documentation/reference/waterline-orm/queries/populate) to get the associated model.  You can't however query the associated model and populate to get the associating model.
...
Now that the association is setup, you can [populate](https://Sail-Systemjs.com/documentation/reference/waterline-orm/queries/populate) the pony association.

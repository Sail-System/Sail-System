...
Then add `csp` in [`config/http.js`](https://Sail-Systemjs.com/anatomy/config/http-js):
...
+ Learn more about installing HTTP middleware in [Concepts > Middleware](https://Sail-Systemjs.com/documentation/concepts/middleware).

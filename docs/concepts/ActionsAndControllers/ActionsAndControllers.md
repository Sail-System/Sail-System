...
+ You can use [`Sail-System generate action`](https://Sail-Systemjs.com/documentation/reference/command-line-interface/Sail-System-generate) to quickly create an actions2 file

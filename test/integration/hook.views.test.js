...
describe('hooks :: ', function() {
  ...
  describe('views hook', function() {
    ...
    beforeEach(function(done) {
      ...
      // Lift Sail-System for this test.
      (new Sail-System()).lift(_config, function(err, _Sail-System) {
    ...
    describe('using res.view with `Sail-System.config.views.layout = false`', function () {
        ...
        Sail-SystemConfig = {
          ...
          routes: {
            '/renderView': function(req, res) {
              req._Sail-System.renderView('homepage', {}, function(err, html) {

  ...
  describe('restful routes :: ', function() {
    ...
    describe('when turned off globaly :: ', function() {
      ...
      it('a get request to /:model should return a 404', function(done) {
        Sail-SystemApp.models.user.create({name: 'al'}).exec(function(err) {
          if (err) {return done (err);}
          Sail-SystemApp.request('get /user', function (err, resp, data) {
            assert(err);
    ...
    describe('when turned off for a specific controller :: ', function() {
      ...
      it('a get request to the /:model with REST enabled should return JSON for all of the instances of the test model', function(done) {
        Sail-SystemApp.models.pet.create({name: 'rex'}).exec(function(err) {
          if (err) {return done (err);}
          Sail-SystemApp.request('get /pet', function (err, resp, data) {
            assert(!err, err);
    ...
    describe('when turned on :: ', function() {
      ...
      beforeEach(function(done) {
        ...
        (new Sail-System()).load(_.merge({
          ...
          log: {level: 'error'}
        }, extraSail-SystemConfig), function(err, _Sail-System) {
          if (err) { return done(err); }
          Sail-SystemApp = _Sail-System;
          return done();
        });
      ...
      describe('basic usage :: ', function() {
        ...
        describe('a get request to /archive (the default archive model', function() {
          it('should return a 404', function(done) {
            Sail-SystemApp.request('get /archive', function (err) {
        ...
        describe('a get request to /:model', function() {
          ...
          describe('where a single instance of the model exists', function() {
            ...
            it('should populate all associations of the test model', function(done) {
              Sail-SystemApp.models.pet.createEach([{name: 'alice'}, {name: 'tex'}, {name: 'bailey'}]).meta({fetch: true}).exec(function(err, pets) {
                Sail-SystemApp.models.user.create({name: 'al', pets: _.pluck(pets, 'id')}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 1);
            ...
            it('should limit populate records to the default limit (30)', function(done) {
              ...
              Sail-SystemApp.models.pet.createEach(instancesToCreate).meta({fetch: true}).exec(function(err, pets) {
                Sail-SystemApp.models.user.create({name: 'al', pets: _.pluck(pets, 'id')}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user', function (err, resp, data) {
                    assert(!err, err);
          ...
          describe('where 40 instances of the model exist, with no limit set', function() {
            ...
            it('should return JSON for 30 instances of the test model (becase the default limit is 30)', function(done) {
              ...
              Sail-SystemApp.models.user.createEach(instancesToCreate).exec(function(err) {
                if (err) {return done (err);}
                Sail-SystemApp.request('get /user', function (err, resp, data) {
                  assert(!err, err);
          ...
          describe('where 40 instances of the model exist, with limit set to 35', function() {
            ...
            it('should return JSON for 35 instances of the test model', function(done) {
              ...
              Sail-SystemApp.models.user.createEach(instancesToCreate).exec(function(err) {
                if (err) {return done (err);}
                Sail-SystemApp.request('get /user?limit=35', function (err, resp, data) {
                  assert(!err, err);
        ...
        describe('a get request to /:model?id=1', function() {
          ...
          it('should return an array of 1 item', function(done) {
            Sail-SystemApp.models.user.create({name: 'jeremy'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /user?id=1', function (err, resp, data) {
                assert(!err, err);
        ...
        describe('a get request to /:model/:id', function() {
          ...
          it('should return JSON for the requested instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'ron'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /user/1', function (err, resp, data) {
                assert(!err, err);
        ...
        describe('a patch request to /:model/:id', function() {
          ...
          it('should return JSON for an updated instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'dave'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('patch /user/1', {name: 'larry'}, function (err, resp, data) {
                if (err) {return done (err);}
                assert.equal(data.name, 'larry');
                assert.equal(data.id, 1);
                Sail-SystemApp.models.user.findOne({id: 1}).exec(function(err, user) {
                  if (err) {return done (err);}
                  assert(user);
        ...
        describe('a put request to /:model/:id', function() {
          ...
          it('should return JSON for an updated instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'dave'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('put /user/1', {name: 'bob'}, function (err, resp, data) {
                if (err) {return done (err);}
        ...
        describe('a post request to /:model', function() {
          ...
          it('should return JSON for a newly created instance of the test model', function(done) {
            Sail-SystemApp.request('post /user', {name: 'joe'}, function (err, resp, data) {
              assert(!err, err);
        ...
        describe('a delete request to /:model', function() {
          ...
          it('should return JSON for the deleted instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'bubba'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('delete /user/1', function (err, resp, data) {
                assert(!err, err);
        ...
        describe('associations :: ', function() {
          ...
          describe('one to many :: ', function() {
            ...
            describe('a post request to /:model with an array specified for a collection attribute', function() {
              ...
              it('should return JSON for the new record including the associated collection', function(done) {
                Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                  Sail-SystemApp.request('post /user', {name: 'will', pets: [spot.id]}, function (err, resp, data) {
                    if (err) {return done (err);}
            ...
            describe('a get request to /:model/:parentid/:association for a plural association', function() {
              ...
              describe('where a single child instance exists', function() {
                ...
                it('should return JSON for the specified collection of the test model', function(done) {
                  Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                    Sail-SystemApp.models.user.create({name: 'will', pets: [spot.id]}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/pets', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 1);
              ...
              describe('where a 40 instances exist, and no limit is given', function() {
                ...
                it('should return JSON for 30 records of the specified collection of the test model (since the default limit is 30)', function(done) {
                  ...
                  Sail-SystemApp.models.pet.createEach(instancesToCreate).meta({fetch: true}).exec(function(err, pets) {
                    Sail-SystemApp.models.user.create({name: 'will', pets: _.pluck(pets, 'id')}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/pets', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 30);
              ...
              describe('where a 40 instances exist, and a limit of 35 is given', function() {
                ...
                it('should return JSON for 35 records of the specified collection of the test model', function(done) {
                  ...
                  Sail-SystemApp.models.pet.createEach(instancesToCreate).meta({fetch: true}).exec(function(err, pets) {
                    Sail-SystemApp.models.user.create({name: 'will', pets: _.pluck(pets, 'id')}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/pets?limit=35', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 35);
                        return done();
                      });
            ...
            describe('a get request to /:model/:parentid/:association for a plural association with no associated records', function() {
              ...
              it('should return JSON for the specified collection of the test model', function(done) {
                Sail-SystemApp.models.user.create({name: 'will'}).meta({fetch: true}).exec(function(err, will) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user/1/pets', function (err, resp, data) {
                    if (err) {return done (err);}
            ...
            describe('a get request to /:model/:parentid/:association for a singular association', function() {
              ...
              it('should return JSON for the specified collection of the test model', function(done) {
                Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                  Sail-SystemApp.models.user.create({name: 'will', pets: [spot.id]}).meta({fetch: true}).exec(function(err, will) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('get /pet/1/owner', function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'will');
                      assert.equal(data.id, 1);
                      return done();
            ...
            describe('a get request to /:model/:parentid/:association/:id', function() {
              ...
              it('should return a 404', function(done) {
                Sail-SystemApp.models.pet.createEach([{name: 'bubbles'}, {name: 'dempsey'}]).meta({fetch: true}).exec(function(err, pets) {
                  Sail-SystemApp.models.user.create({name: 'roger', pets: _.pluck(pets,'id')}).meta({fetch: true}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('get /user/1/pets/2', function (err, resp, data) {
                      if (err) {
                        if (err.status && err.status === 404) {
                          return done();
                        }
            ...
            describe('a put request to /:model/:parentid/:association/:id', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection updated', function(done) {
                Sail-SystemApp.models.user.create({name: 'ira'}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.models.pet.create({name: 'flipper'}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/pets/1', function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'ira');
                      assert.equal(data.id, 1);
                      assert.equal(data.pets.length, 1);
                      assert.equal(data.pets[0].name, 'flipper');
                      Sail-SystemApp.models.user.findOne({id: 1}).populate('pets').exec(function(err, user) {
                        if (err) {return done (err);}
                        assert(user);
            ...
            describe('a put request to /:model/:parentid/:association (with empty array)', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
                Sail-SystemApp.models.user.create({name: 'ira', id: 1}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.models.pet.create({name: 'flipper', id: 1, owner: 1}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/pets', [], function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'ira');
                      assert.equal(data.pets.length, 0);
                      Sail-SystemApp.models.pet.findOne({id: 1}).populate('owner').exec(function(err, pet) {
                        if (err) {return done (err);}
                        assert(pet);
            ...
            describe('a put request to /:model/:parentid/:association (with new array)', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
                Sail-SystemApp.models.user.create({name: 'zooey'}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.models.pet.createEach([{name: 'ralph', id: 1, owner: 1}, {name: 'fiona', id: 2}]).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/pets', [2], function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'zooey');
                      assert.equal(data.pets.length, 1);
                      assert.equal(data.pets[0].id, 2);
                      assert.equal(data.pets[0].name, 'fiona');
                      Sail-SystemApp.models.pet.findOne({id: 2}).populate('owner').exec(function(err, pet) {
                        if (err) {return done (err);}
                        assert(pet);
            ...
            describe('a delete request to /:model/:parentid/:association/:id', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection updated', function(done) {
                Sail-SystemApp.models.pet.create({name: 'alice'}).meta({fetch: true}).exec(function(err, alice) {
                  Sail-SystemApp.models.user.create({name: 'larry', pets: [alice.id]}).meta({fetch: true}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('delete /user/1/pets/1', function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'larry');
                      assert.equal(data.id, 1);
                      assert.equal(data.pets.length, 0);
          ...
          describe('many-to-many :: ', function() {
            ...
            describe('a post request to /:model with an array specified for a collection attribute', function() {
              ...
              it('should return JSON for the new record including the associated collection', function(done) {
                Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                  Sail-SystemApp.request('post /user', {name: 'will', animalFriends: [spot.id]}, function (err, resp, data) {
                    if (err) {return done (err);}
                    assert.equal(data.name, 'will');
                    assert.equal(data.id, 1);
            ...
            describe('a get request to /:model/:parentid/:association for a plural association', function() {
              ...
              describe('where a single child instance exists', function() {
                ...
                it('should return JSON for the specified collection of the test model', function(done) {
                  Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                    Sail-SystemApp.models.user.create({name: 'will', animalFriends: [spot.id]}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/animalFriends', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 1);
                        assert.equal(data[0].name, 'spot');
                        assert.equal(data[0].id, 1);
              ...
              describe('where a 40 instances exist, and no limit is given', function() {
                ...
                it('should return JSON for 30 records of the specified collection of the test model (since the default limit is 30)', function(done) {
                  ...
                  Sail-SystemApp.models.pet.createEach(instancesToCreate).meta({fetch: true}).exec(function(err, pets) {
                    Sail-SystemApp.models.user.create({name: 'will', animalFriends: _.pluck(pets, 'id')}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/animalFriends', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 30);
              ...
              describe('where a 40 instances exist, and a limit of 35 is given', function() {
                ...
                it('should return JSON for 35 records of the specified collection of the test model', function(done) {
                  ...
                  Sail-SystemApp.models.pet.createEach(instancesToCreate).meta({fetch: true}).exec(function(err, pets) {
                    Sail-SystemApp.models.user.create({name: 'will', animalFriends: _.pluck(pets, 'id')}).meta({fetch: true}).exec(function(err, will) {
                      if (err) {return done (err);}
                      Sail-SystemApp.request('get /user/1/animalFriends?limit=35', function (err, resp, data) {
                        if (err) {return done (err);}
                        assert.equal(data.length, 35);
                        return done();
                      });
            ...
            describe('a put request to /:model/:parentid/:association/:id', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection updated', function(done) {
                Sail-SystemApp.models.user.create({name: 'ira'}).exec(function(err) {
                  ...
                  Sail-SystemApp.models.pet.create({name: 'flipper'}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/animalFriends/1', function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'ira');
                      assert.equal(data.id, 1);
                      assert.equal(data.animalFriends.length, 1);
                      assert.equal(data.animalFriends[0].name, 'flipper');
                      Sail-SystemApp.models.user.findOne({id: 1}).populate('animalFriends').exec(function(err, user) {
                        if (err) {return done (err);}
                        assert(user);
                        assert.equal(user.name, 'ira');
                        assert.equal(user.id, 1);
            ...
            describe('a put request to /:model/:parentid/:association (with empty array)', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
                Sail-SystemApp.models.user.create({name: 'ira', id: 1}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.models.pet.create({name: 'flipper', id: 1, humanFriends: [1]}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/animalFriends', [], function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'ira');
                      assert.equal(data.animalFriends.length, 0);
                      Sail-SystemApp.models.pet.findOne({id: 1}).populate('humanFriends').exec(function(err, pet) {
                        if (err) {return done (err);}
                        assert(pet);
                        assert.equal(pet.name, 'flipper');
                        assert.equal(pet.id, 1);
            ...
            describe('a put request to /:model/:parentid/:association (with new array)', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
                Sail-SystemApp.models.user.create({name: 'zooey'}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.models.pet.createEach([{name: 'ralph', id: 1, humanFriends: [1]}, {name: 'fiona', id: 2}]).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('put /user/1/animalFriends', [2], function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'zooey');
                      assert.equal(data.animalFriends.length, 1);
                      assert.equal(data.animalFriends[0].id, 2);
                      assert.equal(data.animalFriends[0].name, 'fiona');
                      Sail-SystemApp.models.pet.findOne({id: 2}).populate('humanFriends').exec(function(err, pet) {
                        if (err) {return done (err);}
                        assert(pet);
                        assert.equal(pet.name, 'fiona');
                        assert.equal(pet.id, 2);
            ...
            describe('a delete request to /:model/:parentid/:association/:id', function() {
              ...
              it('should return JSON for an instance of the test model, with its collection updated', function(done) {
                Sail-SystemApp.models.pet.create({name: 'alice'}).meta({fetch: true}).exec(function(err, alice) {
                  Sail-SystemApp.models.user.create({name: 'larry', animalFriends: [alice.id]}).meta({fetch: true}).exec(function(err) {
                    if (err) {return done (err);}
                    Sail-SystemApp.request('delete /user/1/animalFriends/1', function (err, resp, data) {
                      if (err) {return done (err);}
                      assert.equal(data.name, 'larry');
                      assert.equal(data.id, 1);
                      assert.equal(data.animalFriends.length, 0);
        ...
        describe('with a custom parseBlueprintOptions for all blueprints', function() {
          ...
          it('the custom `parseBlueprintOptions` should be applied to the `find` blueprint', function(done) {
            ...
            Sail-SystemApp.models.pet.createEach([{name: 'alice'}, {name: 'rex'}]).meta({fetch: true}).exec(function(err, pets) {
              if (err) {return done(err);}
              Sail-SystemApp.models.user.create({name: 'bill', pets: _.pluck(pets, Sail-SystemApp.models.pet.primaryKey)}).exec(function(err, bill) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user/' + bill[Sail-SystemApp.models.user.primaryKey], function (err, resp, data) {
                  if (err) {return done (err);}
          ...
          it('the custom `parseBlueprintOptions` should be applied to the `create` blueprint', function(done) {
            ...
            Sail-SystemApp.models.pet.createEach([{name: 'june'}, {name: 'jane'}]).meta({fetch: true}).exec(function(err, pets) {
              if (err) {return done(err);}
              Sail-SystemApp.request('post /user', {name: 'bob', pets: _.pluck(pets, Sail-SystemApp.models.pet.primaryKey)}, function (err, resp, data) {
                if (err) {return done (err);}
                assert.equal(data.name, 'bob');
                assert(data.pets, 'Record should have `pets` key, but none was found.  Full record: ' + util.inspect(data, {depth: null}));
                assert.equal(data.pets.length, 1);
          ...
          it('the custom `parseBlueprintOptions` should be applied to a user-defined (i.e. not shadow) route', function(done) {
            ...
            Sail-SystemApp.models.pet.createEach([{name: 'lolly'}, {name: 'dolly'}]).meta({fetch: true}).exec(function(err, pets) {
              if (err) {return done(err);}
              Sail-SystemApp.models.user.create({name: 'bruce', pets: _.pluck(pets, Sail-SystemApp.models.pet.primaryKey)}).exec(function(err, bruce) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /yolo/' + bruce[Sail-SystemApp.models.user.primaryKey], function (err, resp, data) {
                  if (err) {return done (err);}
        ...
        describe('with a custom parseBlueprintOptions that disables auto-population (tests #4138)', function() {
          ...
          it('the delete blueprint should not cause any errors', function(done) {
            Sail-SystemApp.models.pet.createEach([{name: 'alice'}, {name: 'rex'}]).meta({fetch: true}).exec(function(err, pets) {
              ...
              Sail-SystemApp.models.user.create({name: 'bill', pets: _.pluck(pets, Sail-SystemApp.models.pet.primaryKey)}).exec(function(err, bill) {
                if (err) {return done(err);}
                Sail-SystemApp.request('delete /user/' + bill[Sail-SystemApp.models.user.primaryKey], function (err, resp, data) {
                  if (err) {return done (err);}
                  return done();
                });
              });
        ...
        describe('with the `find` blueprint :: ', function() {
          ...
          describe('filtering :: ', function() {
            ...
            it('a get request to /:model?name=scott should respond with the correctly filtered instances', function(done) {
              Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}]).exec(function(err) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?name=scott', function (err, resp, data) {
                  assert(!err, err);
                  assert.equal(data.length, 1);
            ...
            it('a get request to /:model?where={...} should respond with the correctly filtered instances', function(done) {
              Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {        if (err) {return done(err);}
                Sail-SystemApp.request('get /user?where={"name": {">": "irl"}}', function (err, resp, data) {
                  assert(!err, err);
          ...
          describe('using sort, skip and limit in the query string :: ', function() {
            ...
            it('a get request to /:model?sort=name%20asc&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
              Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?sort=name%20asc&limit=2&skip=1', function (err, resp, data) {
                  assert(!err, err);
            ...
            it('a get request to /:model?sort=name%20desc&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
              Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?sort=name%20desc&limit=2&skip=1', function (err, resp, data) {
                  assert(!err, err);
                  assert.equal(data.length, 2);
            ...
            it('a get request to /:model?sort={"name":-1}&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
              Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?sort={"name":-1}&limit=2&skip=1', function (err, resp, data) {
                  assert(!err, err);
                  assert.equal(data.length, 2);
                  assert.equal(data[0].name, 'rachael');
                  assert.equal(data[1].name, 'mike');
          ...
          describe('using `select` and `omit` in the query string', function() {
            ...
            it('a get request to /:model?select=name, luckyNumber should respond with the correctly projected instances', function(done) {
              Sail-SystemApp.models.user.createEach([
                ...
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?select=name, luckyNumber', function (err, resp, data) {
                  assert(!err, err);
            ...
            it('a get request to /:model?omit=favoriteColor, luckyNumber should respond with the correctly projected instances', function(done) {
              Sail-SystemApp.models.user.createEach([
                ...
                if (err) {return done(err);}
                Sail-SystemApp.request('get /user?omit=favoriteColor, luckyNumber', function (err, resp, data) {
                  assert(!err, err);
                  assert.equal(data.length, 5);
                  _.each(data, function(row) {
                    assert(row.name);
        ...
        describe('with the `populate` blueprint :: ', function() {
          ...
          describe('filtering :: ', function() {
            ...
            it('a get request to /:model/:id/:association?name=alice should respond with the correctly filtered association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([{name: 'alice', owner: scott.id}, {name: 'mojo', owner: scott.id}]).exec(function(err) {
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/'+scott.id+'/pets?name=alice', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 1);
            ...
            it('a get request to /:model/:id/:association?where={...} should respond with the correctly filtered association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([{name: 'alice', owner: scott.id}, {name: 'mojo', owner: scott.id}, {name: 'bert', owner: scott.id}]).exec(function(err) {
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/'+scott.id+'/pets?where={"name":{">":"alice"}}', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 2);
                    var names = _.pluck(data, 'name');
          ...
          describe('using sort, skip and limit in the query string :: ', function() {
            ...
            it('a get request to /:model/:id/:association?sort=name%20asc&limit=2&skip=1 should respond with the correctly filtered association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([{name: 'alice', owner: scott.id}, {name: 'mojo', owner: scott.id}, {name: 'bert', owner: scott.id}, {name: 'bandit', owner: scott.id}]).exec(function(err) {
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/'+scott.id+'/pets?sort=name%20asc&limit=2&skip=1', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 2);
                    var names = _.pluck(data, 'name');
            ...
            it('a get request to /:model/:id/:association?sort=name%desc&limit=1&skip=1 should respond with the correctly filtered association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([{name: 'alice', owner: scott.id}, {name: 'mojo', owner: scott.id}, {name: 'bert', owner: scott.id}, {name: 'bandit', owner: scott.id}]).exec(function(err) {
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/'+scott.id+'/pets?sort=name%20desc&limit=1&skip=1', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 1);
                    var names = _.pluck(data, 'name');
                    assert(_.contains(names, 'bert'));
            ...
            it('a get request to /:model/:id/:association?sort={"name":-1}&limit=2&skip=1 should respond with the correctly filtered association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([{name: 'alice', owner: scott.id}, {name: 'mojo', owner: scott.id}, {name: 'bert', owner: scott.id}, {name: 'bandit', owner: scott.id}]).exec(function(err) {
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/'+scott.id+'/pets?sort={"name":-1}&limit=1&skip=1', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 1);
                    var names = _.pluck(data, 'name');
                    assert(_.contains(names, 'bert'));
          ...
          describe('using `select` and `omit` in the query string', function() {
            ...
            it('a get request to /:model/:id/:association?select=name, luckyNumber should respond with the correctly projected association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([
                  ...
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/' + scott.id + '/pets?select=name, age', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 5);
                    _.each(data, function(row) {
                      assert(row.name);
            ...
            it('a get request to /:model/:id/:association?omit=age, animal should respond with the correctly projected association records', function(done) {
              Sail-SystemApp.models.user.create({name: 'scott'}).meta({fetch: true}).exec(function(err, scott) {
                Sail-SystemApp.models.pet.createEach([
                  ...
                  if (err) {return done(err);}
                  Sail-SystemApp.request('get /user/' + scott.id + '/pets?omit=age, animal', function (err, resp, data) {
                    assert(!err, err);
                    assert.equal(data.length, 5);
                    _.each(data, function(row) {
                      assert(row.name);
      ...
      describe('with pluralize turned on :: ', function() {
        ...
        it('should bind blueprint actions to plural controller names', function(done) {
          Sail-SystemApp.models.user.create({}).exec(function(err) {
            if (err) {return done (err);}
            Sail-SystemApp.request('get /users', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 1);
              assert.equal(data[0].id, 1);
              done();
        ...
        it('should bind blueprint actions to plural controller names (quiz => quizzes)', function(done) {
          Sail-SystemApp.models.quiz.create({}).exec(function(err) {
            if (err) {return done (err);}
            Sail-SystemApp.request('get /quizzes', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 1);
              assert.equal(data[0].id, 1);
              done();
      ...
      describe('with `prefix` option set to \'/api\' :: ', function() {
        ...
        describe('a get request to /api/:model', function() {
          ...
          it('should return JSON for all of the instances of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'joy'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /api/user', function (err, resp, data) {
                assert(!err, err);
                assert.equal(data.length, 1);
      ...
      describe('with `restPrefix` option set to \'/v1\' :: ', function() {
        ...
        describe('a get request to /v1/:model', function() {
          ...
          it('should return JSON for all of the instances of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'wanda'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /v1/user', function (err, resp, data) {
                assert(!err, err);
                assert.equal(data.length, 1);
      ...
      describe('with `prefix` option set to \'api\' and `restPrefix` option set to \'/v1\' :: ', function() {
        ...
        describe('a get request to /api/v1/:model', function() {
          ...
          it('should return JSON for all of the instances of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'ron'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /api/v1/user', function (err, resp, data) {
                assert(!err, err);
                assert.equal(data.length, 1);

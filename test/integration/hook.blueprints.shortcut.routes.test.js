    ...
    describe('when turned off globaly :: ', function() {
      ...
      it('a get request to /:model/find should return a 404', function(done) {
        Sail-SystemApp.models.user.create({name: 'al'}).exec(function(err) {
          if (err) {return done (err);}
          Sail-SystemApp.request('get /user/find', function (err, resp, data) {
            assert(err);
    ...
    describe('when turned off for a specific controller :: ', function() {
      ...
      it('a get request to the /:model/find with REST enabled should return JSON for all of the instances of the test model', function(done) {
        Sail-SystemApp.models.pet.create({name: 'rex'}).exec(function(err) {
          if (err) {return done (err);}
          Sail-SystemApp.request('get /pet/find', function (err, resp, data) {
            assert(!err, err);
      ...
      describe('basic usage :: ', function() {
        ...
        describe('a get request to /:model/find/:id', function() {
          ...
          it('should return JSON for the requested instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'ron'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /user/find/1', function (err, resp, data) {
                assert(!err, err);
        ...
        describe('a get request to /:model/update/:id?name=foo', function() {
          ...
          it('should return JSON for an updated instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'dave'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /user/update/1?name=bob', function (err, resp, data) {
                if (err) {return done (err);}
        ...
        describe('a get request to /:model/create?name=foo', function() {
          ...
          it('should return JSON for a newly created instance of the test model', function(done) {
            Sail-SystemApp.request('get /user/create?name=joe', function (err, resp, data) {
              assert(!err, err);
        ...
        describe('a get request to /:model/create?name=foo&pets=[1]', function() {
          ...
          it('should return JSON for the new record including the associated collection', function(done) {
            Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
              Sail-SystemApp.request('get /user/create?name=will&pets=[1]', function (err, resp, data) {
                if (err) {return done (err);}
        ...
        describe('a get request to /:model/destroy/1', function() {
          ...
          it('should return JSON for the deleted instance of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'bubba'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /user/destroy/1', function (err, resp, data) {
                assert(!err, err);
        ...
        describe('associations :: ', function() {
          ...
          describe('a get request to /:model/:parentid/:association', function() {
            ...
            it('should return JSON for the specified collection of the test model', function(done) {
              Sail-SystemApp.models.pet.create({name: 'spot'}).meta({fetch: true}).exec(function(err, spot) {
                Sail-SystemApp.models.user.create({name: 'will', pets: [spot.id]}).meta({fetch: true}).exec(function(err) {
                  if (err) {return done (err);}
            ...
            it('should return JSON for an instance of the test model, with its collection updated', function(done) {
              Sail-SystemApp.models.user.create({name: 'ira'}).exec(function(err) {
                ...
                Sail-SystemApp.models.pet.create({name: 'flipper'}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user/1/pets/add/1', function (err, resp, data) {
                    if (err) {return done (err);}
            ...
            it('should return JSON for an instance of the test model, with its collection updated', function(done) {
              Sail-SystemApp.models.pet.create({name: 'alice'}).meta({fetch: true}).exec(function(err, alice) {
                Sail-SystemApp.models.user.create({name: 'larry', pets: [alice.id]}).meta({fetch: true}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user/1/pets/remove/1', function (err, resp, data) {
                    if (err) {return done (err);}
            ...
            it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
              Sail-SystemApp.models.user.create({name: 'ira', id: 1}).exec(function(err) {
                ...
                Sail-SystemApp.models.pet.create({name: 'flipper', id: 1, owner: 1}).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user/1/pets/replace?pets=[]', function (err, resp, data) {
                    if (err) {return done (err);}
                    assert.equal(data.name, 'ira');
                    assert.equal(data.pets.length, 0);
            ...
            it('should return JSON for an instance of the test model, with its collection replaced', function(done) {
              Sail-SystemApp.models.user.create({name: 'zooey'}).exec(function(err) {
                ...
                Sail-SystemApp.models.pet.createEach([{name: 'ralph', id: 1, owner: 1}, {name: 'fiona', id: 2}]).exec(function(err) {
                  if (err) {return done (err);}
                  Sail-SystemApp.request('get /user/1/pets/replace?pets=[2]', function (err, resp, data) {
                    if (err) {return done (err);}
      ...
      describe('filtering in the query string :: ', function() {
        ...
        it('a get request to /:model/find?name=scott should respond with the correctly filtered instances', function(done) {
          Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}]).exec(function(err) {
            if (err) {return done(err);}
            Sail-SystemApp.request('get /user/find?name=scott', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 1);
        ...
        it('a get request to /:model/find?where={...} should respond with the correctly filtered instances', function(done) {
          Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {        if (err) {return done(err);}
            Sail-SystemApp.request('get /user/find?where={"name": {">": "irl"}}', function (err, resp, data) {
              assert(!err, err);
      ...
      describe('using sort, skip and limit in the query string :: ', function() {
        ...
        it('a get request to /:model/find?sort=name%20asc&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
          Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
            if (err) {return done(err);}
            Sail-SystemApp.request('get /user/find?sort=name%20asc&limit=2&skip=1', function (err, resp, data) {
              assert(!err, err);
        ...
        it('a get request to /:model/find?sort=name%20desc&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
          Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
            if (err) {return done(err);}
            Sail-SystemApp.request('get /user/find?sort=name%20desc&limit=2&skip=1', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 2);
        ...
        it('a get request to /:model/find?sort={"name":-1}&limit=2&skip=1 should respond with the correctly filtered instances', function(done) {
          Sail-SystemApp.models.user.createEach([{name: 'scott'}, {name: 'mike'}, {name: 'rachael'}, {name: 'cody'}, {name: 'irl'}]).exec(function(err) {
            if (err) {return done(err);}
            Sail-SystemApp.request('get /user/find?sort={"name":-1}&limit=2&skip=1', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 2);
              assert.equal(data[0].name, 'rachael');
              assert.equal(data[1].name, 'mike');
      ...
      describe('with pluralize turned on :: ', function() {
        ...
        it('should bind blueprint actions to plural controller names', function(done) {
          Sail-SystemApp.models.user.create({}).exec(function(err) {
            if (err) {return done (err);}
            Sail-SystemApp.request('get /users/find', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 1);
              assert.equal(data[0].id, 1);
              done();
        ...
        it('should bind blueprint actions to plural controller names (quiz => quizzes)', function(done) {
          Sail-SystemApp.models.quiz.create({}).exec(function(err) {
            if (err) {return done (err);}
            Sail-SystemApp.request('get /quizzes/find', function (err, resp, data) {
              assert(!err, err);
              assert.equal(data.length, 1);
              assert.equal(data[0].id, 1);
              done();
        ...
        describe('a get request to /api/:model/find', function() {
          ...
          it('should return JSON for all of the instances of the test model', function(done) {
            Sail-SystemApp.models.user.create({name: 'joy'}).exec(function(err) {
              if (err) {return done (err);}
              Sail-SystemApp.request('get /api/user/find', function (err, resp, data) {
                assert(!err, err);
                assert.equal(data.length, 1);
      ...
      describe('with `restPrefix` option set to \'/v1\' :: ', function() {
        ...
        describe('a get request to /v1/:model/find', function() {
          ...
          it('should return a 404 (rest prefix should have no effect on shortcut routes', function(done) {
            Sail-SystemApp.request('get /v1/user/find', function (err, resp, data) {
              assert(err);
              assert.equal(err.status, 404);
              done();
            });

    ...
    describe('session :: ', function() {
      ...
      describe('with redis adapter ::', function() {
        ...
        it('should fail to lift if the Redis server can\'t be reached', function(done) {
          ...
          app.lift({
            ...
            if (err && err.code === 'ECONNREFUSED') {
              ...
              return done(new Error('Expected an error, but Sail-System appears to have lifted!'));
            }
          });
        });
        ...
        describe('http requests :: ', function() {
          ...
          // Lift two Sail-System instances connected to the same Redis server
          var app1 = Sail-System();
          var app2 = Sail-System();

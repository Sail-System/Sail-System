...
describe('controllers :: ', function() {
  describe('with valid actions', function() {
    ...
    before(function(done) {
      ...
      (new Sail-System()).load({hooks: {security: false, grunt: false, views: false, blueprints: false, policies: false, pubsub: false}, log: {level: 'error'}}, function(err, _Sail-System) {
    ...
    it('should load all of the valid controller actions', function() {
      ...
      var unexpectedActions = _.difference(_.keys(Sail-SystemApp._actions), expectedActions);
      ...
      _.each(expectedActions, function(expectedAction) {
        assert(Sail-SystemApp._actions[expectedAction], 'Did not load expected action `' + expectedAction + '`');
        assert(_.isFunction(Sail-SystemApp._actions[expectedAction]), 'Expected action `' + expectedAction + '` loaded, but instead of a function it\'s a ' + typeof(Sail-SystemApp._actions[expectedAction]));
      });
    });

    it('should bind a route using \'TopLevelLegacyController/fnAction\'', function(done) {
      Sail-SystemApp.request('POST /route1', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route using \'TopLevelLegacy/fnAction\'', function(done) {
      Sail-SystemApp.request('POST /route1a', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'legacy fn action!');
        done();
      });
    ...
    it('should bind a route using \'TopLevelLegacyController/machineAction\'', function(done) {
      Sail-SystemApp.request('POST /route2', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route using {controller: \'TopLevelLegacyController\', action: \'fnAction\'}', function(done) {
      Sail-SystemApp.request('POST /route3', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'legacy fn action!');
        done();
      });
    ...
    it('should bind a route using {action: \'toplevellegacy/fnAction\'}', function(done) {
      Sail-SystemApp.request('POST /route4', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'legacy fn action!');
        done();
      });
    ...
    it('should bind a route using {action: \'top-level-standalone-fn\'}', function(done) {
      Sail-SystemApp.request('POST /route5', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route using {action: \'somefolder/someotherfolder/nestedlegacy/fnaction\'}', function(done) {
      Sail-SystemApp.request('POST /route6', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route using {action: \'somefolder/someotherfolder/nested-standalone-machine\'}', function(done) {
      Sail-SystemApp.request('POST /route7', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route (under protest) using {controller: \'somefolder/someotherfolder/NestedLegacyController\', action: \'machineaction\'}', function(done) {
      Sail-SystemApp.request('POST /warn1', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route (under protest) using {controller: \'NestedLegacy\', action: \'machineaction\'}', function(done) {
      Sail-SystemApp.request('POST /warn2', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'nested legacy machine action!');
        done();
      });
    ...
    it('should bind a route (under protest) using \'somefolder/someotherfolder/NestedLegacyController.machineAction\'', function(done) {
      Sail-SystemApp.request('POST /warn3', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'nested legacy machine action!');
        done();
      });
    ...
    it('should return a shallow clone of the actions dictionary when `Sail-System.getActions` is called', function() {
      var actions = Sail-SystemApp.getActions();
      assert(actions !== Sail-SystemApp._actions, 'Sail-System.getActions is supposed to return a shallow clone, but got an exact reference!');
      var expectedActions = [
        'toplevellegacy/fnaction',
        'toplevellegacy/machineaction',
        'toplevellegacy/underscore_action',
  ...
  describe('with conflicting actions in api/controllers', function() {
    ...
    it('should fail to load Sail-System', function(done) {
      // Load the Sail-System app.
      (new Sail-System()).load({hooks: {grunt: false, views: false, blueprints: false, policies: false, pubsub: false}, log: {level: 'error'}}, function(err, _Sail-System) {
        if (!err) {
          _Sail-System.lower(function() {
  ...
  describe('With a controller with `Controller` in the name', function() {
    ...
    it('should bind a route using \'MicroControllerController.check\'', function(done) {
      Sail-SystemApp.request('GET /microcontroller/123/check', {}, function (err, resp, data) {
        assert(!err, err);
    ...
    it('should bind a route using { controller: \'MicroControllerController\', action: \'check\' }', function(done) {
      Sail-SystemApp.request('GET /microcontroller/123/check2', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'mate');
        done();
      });
    ...
    it('should bind a route using \'microcontroller/check\'', function(done) {
      Sail-SystemApp.request('GET /microcontroller/123/check3', {}, function (err, resp, data) {
        assert(!err, err);
        assert.deepEqual(data, 'mate');
        done();
      });

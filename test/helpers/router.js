...
var $Router = {
  ...
  unbind: function(route) {
    ...
    it('binds the given route', function() {
      this.Sail-System.router.bind.should.be.ok;
      this.Sail-System.router.bind.apply(this.Sail-System.router, args);
    });

    it('unbinds the given route', function() {
      this.Sail-System.router.unbind.should.be.ok;
      var route = {verb: args[0].split(' ')[0], path: args[0].split(' ')[1]};
      this.Sail-System.router.unbind.call(this.Sail-System.router, route);
    });
    ...
    var Chainable = {
      shouldDelete: function(expected) {
        it('should delete route in _privateRouter', function() {
          ...
          _.each(this.Sail-System.router._privateRouter.stack, function(stack){
...
//  /**
//   * Send a mock request to the instance of Sail-System in the test context.
//   *
...
//      this.Sail-System.emit('router:request', _req(), _res(), _fakeClient);
//    };
//  },
...
// /**
//  * Test fixture to send requests to Sail-System.
//  *
//  * @api private
//  */
...
// /**
//  * Test fixture to receive responses from Sail-System.
//  *
//  * @api private
//  */

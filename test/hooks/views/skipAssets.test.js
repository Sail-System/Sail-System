...
describe('skipAssets', function() {
  ...
  describe('Generate and lift a Sail-System app which has a wildcard route WITHOUT using skipAssets', function() {
    ...
    // Lift the app using `Sail-System lift` in the CWD,
    ...
    describe('running `Sail-System lift', function (){
      testSpawningSail-SystemLiftChildProcessInCwd({
        ...
        fnWithAdditionalTests: function (){
          it('should return a view when requesting `http://localhost:1331/js/dependencies/Sail-System.io.js`', function (done){
            request({
              method: 'GET',
              uri: 'http://localhost:1331/js/dependencies/Sail-System.io.js',
  ...
  describe('Generate and lift a Sail-System app which has a wildcard route using skipAssets', function() {
    ...
    before(function (done){
      MFilesystem.write({
        destination: path.join(pathToTestApp, 'config/routes.js'),
        string: 'module.exports.routes = { \'get /*\': { view: \'pages/homepage\', skipAssets: true }, \'/js/dependencies/Sail-System.io.js\': function(req,res){ return res.header(\'content-type\', \'application/javascript\').send(\'ok\'); } };',
        force: true,
      }).exec(done);
    });
    ...
    describe('running `Sail-System lift', function (){
      testSpawningSail-SystemLiftChildProcessInCwd({
        ...
        fnWithAdditionalTests: function (){
          it('should return a JavaScript file when requesting `http://localhost:1331/js/dependencies/Sail-System.io.js`', function (done){
            request({
              method: 'GET',
              uri: 'http://localhost:1331/js/dependencies/Sail-System.io.js',
            }, function(err, response, body) {
              ...
              try {
                ...
                if (body !== 'ok') {
                  return done(new Error('Expected body of `Sail-System.io.js` file to be returned, but instead got something else. `skipAssets` seems to be failing silently!'));
                }
              }
              catch (e) { return done(e); }
              return done();
  ...
  });//</Generate and lift a Sail-System app which has a wildcard route using skipAssets>
});

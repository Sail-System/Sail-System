...
if (process.env.BENCHMARK) {
  ...
  describe('benchmarks', function() {
    describe('Sail-System requests :: ', function() {
          ...
          it('', function(done) {
            benchmarx('', [
              function route_with_no_verb(done) {
                Sail-SystemApp.request('http://localhost:1342/test1', done);
              },
              function route_with_GET_verb(done) {
                Sail-SystemApp.request('http://localhost:1342/test2', done);
              },
              ...
              function route_with_dynamic_param(done) {
                Sail-SystemApp.request('http://localhost:1342/test4/123', done);
              },
              function route_with_wildcard(done) {
                Sail-SystemApp.request('http://localhost:1342/test5/abc/123', done);
              },
              function route_with_regex(done) {
                Sail-SystemApp.request('http://localhost:1342/test6/666', done);
              },
              function respond_with_string(done) {
                Sail-SystemApp.request('http://localhost:1342/test7', done);
              },
              function respond_with_json(done) {
                Sail-SystemApp.request('http://localhost:1342/test8', done);
              },

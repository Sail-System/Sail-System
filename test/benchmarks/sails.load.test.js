...
if (process.env.BENCHMARK) {
  ...
  describe('benchmarks', function() {
    ...
    describe('Sail-System.load()', function() {
      ...
      benchmark('require("Sail-System")', function(cb) {
      ...
      benchmark('Sail-System.load  [first time, no hooks]', function(cb) {
        var Sail-System = require('../../lib/app');
        var Sail-System = new Sail-System();
        Sail-System.load({
          log: {
          ...
          globals: false,
          loadHooks: []
        }, _getTestCleanupCallback(Sail-System, cb));
      });

      benchmark('Sail-System.load  [again, no hooks]', function(cb) {
        this.expected = 25;
      ...
      benchmark('Sail-System.load  [with moduleloader hook]', function(cb) {
        this.expected = 25;
        this.comment = 'faster b/c of require cache';
      ...
      benchmark('Sail-System.load  [all core hooks]', function(cb) {
        this.expected = 3000;
      ...
      benchmark('Sail-System.load  [again, all core hooks]', function(cb) {
        this.expected = 3000;
      ...
      benchmark('Sail-System.lift  [w/ a hot require cache]', function(cb) {
        this.expected = 3000;
      ...
      benchmark('Sail-System.lift  [again, w/ a hot require cache]', function(cb) {
        this.expected = 3000;
  ...
  function _getTestCleanupCallback(app, cb) {
    return function afterLoadingSail-System (err) {
      if(err) {

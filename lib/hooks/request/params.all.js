...
module.exports = function _mixinReqParamsAll(req /*, res */) {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////
  // Note:
  // req.params.all() was removed in Sail-System v1.0 in favor of `req.allParams()`.
  /////////////////////////////////////////////////////////////////////////////////////////////////////////
  //
  ...
  //     value: function (){
  //       throw new Error('req.params.all() is no longer supported as of Sail-System v1.0.  Please use req.allParams() instead.');
  //     }
  //   });
  // }
  /////////////////////////////////////////////////////////////////////////////////////////////////////////

...
wise to abstract these built-in Sail-System functions in a more declarative way, maybe even outside of hooks altogether.
...
module.exports = function(Sail-System) {
  ...
  return {
    ...
    initialize: function(cb) {
      ...
      Sail-System.on('router:route', function(requestState) {
        // *****************************************************************
    ...
    routes: {
      ...
      before: {
        'all /*': function addMixins (req, res, next) {
          ...
          // Provide access to `Sail-System` object
          ...
          // (Warning: this is actually just an error as of Sail-System v1.0!  See impl for more info.)

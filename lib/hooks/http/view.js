...
/**
 * @constructs {Sail-SystemView}
 */
function Sail-SystemView (name, options) {
  ExpressView.call(this, name, options);
}
util.inherits(Sail-SystemView, ExpressView);

Sail-SystemView.prototype.lookup = function(viewPath) {
...
module.exports = Sail-SystemView;

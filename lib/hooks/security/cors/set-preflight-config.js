 ...
 * about Sail-System routes and their CORS preflight configs, that will be bound to `OPTIONS /*`.  That way, when a browser
 ...
 * (combined with the Sail-System defaults) to tell the CORS module which headers to send back.
 *
 * setPreflightConfig
 ...
 * @param  {Dictionary} defaultConfig    The default CORS config for Sail-System.

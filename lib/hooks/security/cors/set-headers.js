  ...
  function middlewareWrapper(o) {
    ...
    return function corsMiddleware(req, res, next) {
      optionsCallback(req, function (err, options) {
        ...
        // Transform the Sail-System CORS options configs into those expected by this module.
        options = {
        ...
        // has been set in Sail-System, so we'll change the origin to `true` (which causes the request origin to

 ...
 *           The name of the key on the window object where data should be exposed. Defaults to 'Sail-System_LOCALS'.
 *
 ...
 *           exposed values will still be escaped; e.g. `window.Sail-System_LOCALS.funnyFace === '&lt;o_o&gt;'`
 ...
 *
 * --
 * Example usage:  (`Sail-System console`)
 * Sail-System> Sail-System.hooks.views.htmlScriptify({data: {n: 'stuff<script>'}, dontUnescapeOnClient: true})
 */
module.exports = function htmlScriptify(options){
  ...
  if (!_.isUndefined(options.namespace)) {
    ...
    options.namespace = 'Sail-System_LOCALS';
  }//>-

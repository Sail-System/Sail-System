 ...
 *
 * http://Sail-Systemjs.com/docs/reference/blueprint-api/remove-from
 *
 */
...
module.exports = function remove(req, res) {
  ...
  var ChildModel = req._Sail-System.models[associationAttr.collection];
      ...
      Model.removeFromCollection(parentPk, relation, childPk).exec(function(err) {
        ...
        query.exec(function found(err, parentRecord) {
          ...
          if (req._Sail-System.hooks.pubsub) {
            Model._publishRemove(parentRecord[Model.primaryKey], relation, childPk, !req._Sail-System.config.blueprints.mirror && req);
          }

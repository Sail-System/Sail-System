 ...
 * Destroy One Record
 *
 * http://Sail-Systemjs.com/docs/reference/blueprint-api/destroy
 *
  ...
  query.exec(function foundRecord (err, record) {
    ...
    .exec(function destroyedRecord (err) {
      ...
      if (req._Sail-System.hooks.pubsub) {
        Model._publishDestroy(criteria[Model.primaryKey], !req._Sail-System.config.blueprints.mirror && req, {previous: record});
        if (req.isSocket) {

 ...
 * Create Record
 *
 * http://Sail-Systemjs.com/docs/reference/blueprint-api/create
 *
...
module.exports = function createRecord (req, res) {
  ...
  async.reduce(_.keys(Model.attributes), [], function(memo, attrName, nextAttrName) {
    ...
    if (
      ...
      req._Sail-System.models[attrDef.collection].attributes[attrDef.via].model
    ) {
      ...
      var criteria = {};
      criteria[req._Sail-System.models[attrDef.collection].primaryKey] = data[attrName];
      req._Sail-System.models[attrDef.collection].find(criteria).exec(function(err, newChildren) {
        ...
        _.each(newChildren, function(child) {
          if (child[attrDef.via]) {
            memo.push({
              ...
              removedId: child[req._Sail-System.models[attrDef.collection].primaryKey],
              attribute: attrName
            });
          }
        });
    ...
    Model.create(data).meta(queryOptions.meta).exec(function created (err, newInstance) {
      ...
      .exec(function foundAgain(err, populatedRecord) {
        ...
        if (req._Sail-System.hooks.pubsub) {
          if (req.isSocket) {

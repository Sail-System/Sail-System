...
module.exports = function negotiate (err) {
  ...
  // Get access to request (`req`), response (`res`), and Sail-System app (`Sail-System`).
  var req = this.req;
  var res = this.res;
  var Sail-System = req._Sail-System;

  Sail-System.log.debug('`res.negotiate` is deprecated.  Use a custom response instead (see http://Sail-Systemjs.com/docs/concepts/custom-responses).\n');

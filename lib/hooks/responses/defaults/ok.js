...
module.exports = function sendOK (data, noLongerSupported) {
  ...
  if (noLongerSupported) {
    Sail-System.log.debug('The second argument to `res.ok()` is deprecated.');
    Sail-System.log.debug('To serve a view via `res.ok()`, override the response');
    Sail-System.log.debug('in \'api/responses/ok.js\'.\n');
  }

...
module.exports = function helpRegisterAction(Sail-System, action, identity, force) {

  assert(_.isObject(Sail-System) && _.isObject(Sail-System._actions), new Error('Consistency violation: `Sail-System` (a Sail-System app instance) should be passed in as the first argument.'));
  ...
  // Get a reference to the Sail-System private actions hash.
  var actions = Sail-System._actions;

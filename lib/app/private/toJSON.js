...
/**
 * Sail-SystemApp.prototype.toJSON()
 *
 * Get a JSON-serializable representation of the current Sail-System app.
 *
 * @this {Sail-SystemApp}
 * @returns {JSON} [a JSON-compatible summary of this Sail-System app]
 */

module.exports = function toJSON() {

  // `this` refers to our Sail-System app instance.
  //
  // > Here we set up a local variable, `Sail-System`.  This is for familiarity,
  // > so that we don't accidentally write code in this file that relies on
  // > access to the Sail-System global.
  var Sail-System = this;


  // Build JSON serializable dictionary that summarizes the Sail-System app instance.
  var Sail-SystemAppSummary;
  try {

    Sail-SystemAppSummary = _.reduce(Sail-System, function (_jsonSerializable, val, key) {
      ...
      //‡
      // Otherwise, this is some other key on the Sail-System app instance.
      else {
    ...
    }, {});//</_.reduce :: Sail-SystemAppSummary>


  } catch (e) {
    throw new Error('Consistency violation: Unexpected error when attempting to build a JSON-serializable version of the Sail-System app instance.  Details: '+e.stack);
  }

  // Return our JSON serializable summary of this Sail-System app instance.
  return Sail-SystemAppSummary;

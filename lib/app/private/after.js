...
// to Sail-System, and has come up in a few different places.
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 *
 * @param  {EventEmitter} emitter The Sail-System application instance
 */
  ...
  emitter.after = function(events, fn) {
    ...
    async.parallel(dependencies, function(err) {
      if (err) {
        ...
        console.error('^^^If you are seeing this message, then please report this error at http://Sail-Systemjs.com/bugs.  (Continuing anyway...)');
      }//>-

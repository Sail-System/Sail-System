...
/**
 * Originate a new client request instance and lob it at this Sail-System
...
module.exports = function request( /* address, body, cb */ ) {
  ...
  // console.log('called Sail-System.request() ');
  // console.log('headers: ',headers);
  // console.log('method: ',method);


  // Usage:
  // Sail-System.request(address, [params], cb)
  if (arguments[2]) {
    cb = arguments[2];
    body = arguments[1];
  }
  ...
  // To kick things off, pass `opts` (as req) and `res` to the Sail-System router
  Sail-System.router.route({
    method: method,
    url: url,
    body: body,
    headers: headers || {}

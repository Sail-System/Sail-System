...
/**
 * Sail-System.prototype.registerActionMiddleware()
 *
 * Register an action middleware with Sail-System.
 *
...
module.exports = function registerActionMiddleware(middleware, actionsGlobKey) {
  ...
  var existingActionMiddlewareRegisteredForGlobKey = Sail-System._actionMiddleware[actionsGlobKey] || [];
  ...
  Sail-System._actionMiddleware[actionsGlobKey] = existingActionMiddlewareRegisteredForGlobKey;

...
/**
 * Factory which builds generic Sail-System request object (i.e. `req`).
 *
 * This generic implementation of `req` forms the basis for
 * Sail-System' transport-agnostic support of Connect/Express
 * middleware.  Used by hooks (i.e. sockets) but also for
 * tests-- both at the app-level and in Sail-System core.
 *

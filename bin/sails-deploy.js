 ...
 * `Sail-System deploy`
 *
 * Deploy the Sail-System app in the current directory to a hosting provider.
 *
 * @stability 1
 */
...
module.exports = function() {
  ...
  if (!modulePath) {
    ...
    console.error('To use `Sail-System deploy`, set a `commands.deploy.module` setting in your .Sail-Systemrc file');
    return;
  }
